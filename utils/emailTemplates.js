...
/**
 * Styled HTML invoice email (matching the payment link design)
 * @param {Object} data
 * @param {string} data.customerName
 * @param {string} data.orderTitle
 * @param {string} data.invoiceType
 * @param {number} data.amount
 * @param {string} [data.link]
 */
        ...
        <tr>
          <td style="background:#0d1117;text-align:center;padding:25px;">
            <img 
              ...
              style="display:block;margin:auto;max-width:130px;height:auto;">
            <h2 style="color:#58a6ff;margin:15px 0 0;font-size:22px;">
        ...
        <tr>
          <td style="padding:35px 40px;">
            ...
            <p style="color:#333333;line-height:1.6;font-size:15px;">
              ...
              The total due is <strong>£${amount.toFixed(2)}</strong>.
            </p>
